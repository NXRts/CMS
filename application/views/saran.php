                    ...
                    <div class="content-page">
                        <div class="row">
                            <div class="col-md-12 col-sm-9">
                                <h2>Kolom keluh kesah</h2>
                                <p>Anda bisa memberi saya masukan, kritik, bahkan anda juga bisa curhat disini. <br>
                                    Privasi anda aman.
                                </p>
                            </div>
                            <form action="" method="post">
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col mb-3">
                                            <label class="form-label">Saran, Kritik, DLL</label>
